    ...
    <main className="bg-[#fff7f1] text-[#5b1725]">
      <section className="grid gap-8 px-4 py-16 sm:px-8 sm:py-20 lg:grid-cols-[0.95fr_1.05fr] lg:px-14 lg:py-28">
        ...
        <div className="flex flex-col justify-center">
          <Link className="mb-8 text-sm font-black text-[#9f5f6f]" href="/services">
            Back to services
          </Link>
          ...
          <div className="mt-8 flex flex-col gap-3 min-[520px]:flex-row">
            ...
            <Link className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[#d8c1b4] bg-white px-5 py-3 text-sm font-black" href="/services">
              View all services
            </Link>
          </div>
        </div>
